...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Subscription.category'
        db.add_column('subscription_subscription', 'category', self.gf('django.db.models.fields.CharField')(default='', max_length=64), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Subscription.category'
        db.delete_column('subscription_subscription', 'category')
    ...
    models = {
        'actstream.action': {
            ...
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 10, 20, 9, 47, 355114)'}),
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 10, 20, 9, 47, 365178)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2015, 11, 10, 20, 9, 47, 365044)'}),
        ...
        'subscription.subscription': {
            ...
            'category': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '64'}),
